...
namespace HomeRecipes.EntityClasses
{
	...
	
	{
		...
		protected class RecipeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeEntity", InheritanceHierarchyType.None, false, (int)HomeRecipes.EntityType.RecipeEntity, typeof(RecipeEntity), typeof(RecipeEntityFactory), false);
			}
		}
