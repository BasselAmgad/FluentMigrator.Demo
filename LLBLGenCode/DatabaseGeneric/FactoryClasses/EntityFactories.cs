...
namespace HomeRecipes.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, HomeRecipes.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((HomeRecipes.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", HomeRecipes.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", HomeRecipes.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", HomeRecipes.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(HomeRecipes.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(HomeRecipes.EntityType)))
			{
				var factory = GetFactory((HomeRecipes.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the HomeRecipes.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(HomeRecipes.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case HomeRecipes.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case HomeRecipes.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case HomeRecipes.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the HomeRecipes.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (HomeRecipes.EntityType)Enum.Parse(typeof(HomeRecipes.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((HomeRecipes.EntityType)Enum.Parse(typeof(HomeRecipes.EntityType), leftOperandEntityName, false), joinType, (HomeRecipes.EntityType)Enum.Parse(typeof(HomeRecipes.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (HomeRecipes.EntityType)Enum.Parse(typeof(HomeRecipes.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((HomeRecipes.EntityType)entityTypeValue); }
